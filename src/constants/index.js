...
export const CONTENT_BY_LANG = {
  es: {
    aboutMe: {
      description:
        "Soy Ingeniero de Software con formación en Electrónica, Robótica y Mecatrónica, y me siento cómodo moviéndome entre software, sistemas y desarrollo de bajo nivel. Me adapto rápido a nuevas tecnologías y entornos, y disfruto aprendiendo a través de proyectos exigentes. Esa forma de trabajar me ha permitido aportar valor desde fases tempranas y desenvolverme con soltura en equipos y contextos muy distintos.",
    },
    navLinks: [
    ...
    partnerReviews: [
      {
        ...
        review:
          "Trabajar con Adrián fue una experiencia fantástica. Transformó nuestra web anticuada en una plataforma moderna y fácil de usar. Su atención al detalle y compromiso con la calidad son sobresalientes. Lo recomiendo totalmente para cualquier proyecto web.",
      },
    ],
    myProjects: [
      {
        title: "Diseño e implementación de un sistema de adquisición de datos para un sensor óptico",
        desc: "Este proyecto consistió en el diseño e implementación de un sistema completo de adquisición de datos para un sensor óptico, capaz de configurar, capturar y almacenar información en tiempo real con un alto nivel de fiabilidad. La solución se desarrolló sobre FPGA con VHDL y se completó con software de apoyo para el control del sistema y el procesado eficiente de los datos.\nEl trabajo no se limitó a la implementación: también incluyó la integración de hardware y software, la puesta a punto del flujo de adquisición y la validación del comportamiento del sensor frente a los requisitos definidos. Esto permitió caracterizar el sistema de forma rigurosa y reducir incertidumbres en un entorno técnico especialmente sensible.\nSe trata de un proyecto con claro enfoque de ingeniería aplicada, realizado en colaboración con Alter Technology TUV Nord dentro de una línea de investigación orientada al desarrollo de una plataforma modular para caracterización de sensores de imagen.",
        href: "/pdf/TFG_Lara_Guarino.pdf",
        checkLinkTxt: "Ver documento (Español)",
      ...
      },
      {
        ...
        desc: "Este portfolio web es un proyecto personal concebido no solo como escaparate, sino como una demostración práctica de cómo entiendo el desarrollo de software: combinar criterio técnico, diseño intencional y una experiencia de usuario cuidada. Está construido con React, TypeScript, Vite y Tailwind CSS, con especial atención al rendimiento, la claridad estructural y la fluidez de las interacciones.\nLa aplicación incorpora escenas 3D, transiciones, contenido bilingüe y una navegación no convencional basada en una mesa interactiva, lo que me permitió trabajar tanto la parte visual como la organización del código, la mantenibilidad y la coherencia global del producto.\nEs un proyecto que representa bien mi perfil porque une desarrollo frontend moderno, gusto por el detalle y capacidad para convertir una idea personal en una solución técnica sólida, diferencial y bien rematada.",
      ...
      },
      {
        ...
        desc: "Este proyecto fue presentado en Tecnoingenia 2019, donde obtuvo el primer premio de la cuarta categoría. Consistió en el diseño y construcción de un mini panel solar capaz de orientarse automáticamente hacia la posición con mayor aprovechamiento de luz.\nEl sistema integraba cuatro sensores fotosensibles distribuidos alrededor del panel, dos servomotores y una placa Arduino como unidad de control. A partir de la diferencia de luz detectada por los sensores, el Arduino calculaba la orientación más favorable y accionaba los servos para ajustar la inclinación y el giro del panel.\nFue uno de mis primeros proyectos completos de electrónica y control, y me permitió trabajar de forma práctica la lectura de sensores, el control de actuadores, la integración hardware-software y la construcción de un prototipo funcional orientado a mejorar la eficiencia energética.",
    ...
    workExperiences: [
      {
        ...
        pos: "Investigador en el Departamento de Electrónica",
        duration: "Sept 2023 - Abr 2024",
        title:
          "Diseñé e implementé un sistema de adquisición de datos para sensores ópticos basado en FPGA, combinando VHDL, C y PetaLinux para cubrir desde el control embebido hasta la captura fiable de información en tiempo real. Desarrollé también la gestión de interrupciones DMA a nivel de kernel, mejorando la eficiencia del flujo de datos, la capacidad de respuesta del sistema y la estabilidad del comportamiento en operación.\nEl trabajo incluyó integración hardware-software, ajuste del pipeline de adquisición, caracterización del sensor y validación de extremo a extremo frente a requisitos técnicos. Esta etapa me dio una base muy sólida en sistemas embebidos, software cercano al hardware y entornos donde el rigor técnico es imprescindible para obtener resultados fiables.",
        icon: "/assets/university.png",
      },
      {
        id: 2,
        name: "Bertrandt Group",
        pos: "Ingeniero de Software en prácticas",
        duration: "May 2024 - Oct 2024",
        title:
          "Trabajé en la mejora de la plataforma de robótica autónoma Philobot con C++ y ROS, integrando modelos YOLO mediante TensorFlow y PyTorch para detección de objetos en tiempo real. Desplegué pipelines de inferencia orientados a mejorar el reconocimiento, reducir la latencia de respuesta y mantener la coherencia entre software, percepción y comportamiento del sistema.\nEsta etapa me permitió consolidar una forma de trabajo muy práctica: iteración rápida, análisis técnico, resolución de problemas reales y colaboración con otros perfiles dentro de un entorno Agile/Scrum. Fue una experiencia muy útil para reforzar tanto la base de desarrollo como la orientación a producto y rendimiento.",
      ...
      },
      {
        ...
        title:
          "Investigué interfaces humano-máquina adaptativas para el programa europeo FCAS dentro del proyecto EPIIC, contribuyendo a mejorar la fiabilidad de integración entre sistemas modulares en un contexto internacional y técnicamente muy exigente. Esta experiencia me acercó a un entorno de ingeniería donde interoperabilidad, consistencia funcional y coordinación entre organizaciones tienen un peso real en el resultado final.\nDe forma paralela, desarrollé APIs backend en Python y aplicaciones de escritorio en Java para proyectos de Airbus, optimizando flujos de datos, reduciendo sobrecarga de procesamiento y mejorando la integración entre componentes. También participé en workshops internacionales, reforzando mi capacidad para trabajar con equipos multidisciplinares y moverme con soltura en entornos aeroespaciales y de alta criticidad.",
        icon: "/assets/bertrandt.svg",
      },
      {
        id: 4,
        ...
        title:
          "Defino la arquitectura de software y las especificaciones funcionales de un sistema radar de defensa desarrollado por Indra, dentro de un entorno donde la criticidad del producto exige rigor, trazabilidad y consistencia técnica en todo el ciclo de vida. Mi trabajo combina visión de sistema con detalle de ingeniería, asegurando que requisitos, arquitectura, interfaces y decisiones de diseño permanezcan alineados.\nTambién diseño procesos de verificación y validación acordes a los estándares del sector y colaboro directamente con cliente para mantener coherencia entre necesidades operativas, implementación y evidencia de cumplimiento. Es una experiencia especialmente valiosa por su cercanía a software de misión crítica y por el nivel de exigencia que impone el sector defensa en términos de calidad, claridad y responsabilidad técnica.",
        icon: "/assets/bertrandt.svg",
      },
    ],
    myAbilities: [
      {
        id: 1,
        title: "Software",
        desc: "Mi base está en el desarrollo de software con foco en estructura, calidad técnica y sentido de sistema. Trabajo sobre todo con Python, Java, C++ y MATLAB, y me siento cómodo construyendo soluciones apoyadas en arquitectura, APIs, bases de datos, modelado UML y criterios claros de mantenibilidad.\nNo entiendo el software como código aislado, sino como parte de un sistema que debe responder a requisitos reales y sostenerse en el tiempo. Por eso presto mucha atención a la claridad del diseño, la trazabilidad, la verificación y la validación, especialmente en entornos donde el margen de error es bajo.\nBuena parte de mi experiencia ha estado ligada a defensa y aeroespacio, sectores en los que la robustez, la consistencia técnica y la disciplina de ingeniería importan tanto como la implementación en sí.",
        icons: [ICONS.python, ICONS.java, ICONS.cpp, ICONS.matlab, ICONS.mysql],
      },
      {
        id: 2,
        title: "Herramientas",
        desc: "A lo largo de distintos proyectos he consolidado una forma de trabajo apoyada en herramientas de ingeniería, colaboración y control técnico. Uso Git en el día a día para versionado, Jira para organización y seguimiento, y VS Code como entorno habitual de desarrollo.\nTambién he trabajado con IBM DOORS para gestionar requisitos, cambios y trazabilidad, algo especialmente relevante en entornos de defensa y aeroespacio donde cada decisión necesita justificación técnica y evidencia de cumplimiento. Esta forma de trabajar me dio una visión más completa de cómo conectar necesidades de sistema, implementación y validación.\nMe manejo con soltura en sistemas Linux y Windows, incluyendo entornos WSL, y utilizo herramientas como MATLAB y Wireshark, cuando son requeridas, para tareas de análisis, desarrollo, integración y validación técnica.",
        icons: [ICONS.git, ICONS.docker, ICONS.ubuntu],
      },
      {
        id: 3,
        title: "Firmware",
        desc: "Mi interés por los sistemas de bajo nivel me llevó de forma natural al desarrollo firmware y embebido, trabajando con C y VHDL sobre plataformas FPGA y SoC como Zynq. Esa base me permitió entender con profundidad la relación entre hardware y software, y desenvolverme con soltura en sistemas donde rendimiento, temporización y fiabilidad son factores reales de diseño.\nEl trabajo con PetaLinux y kernel Linux me dio visibilidad del ciclo completo: arranque, integración hardware, gestión de datos, capas de software y validación del comportamiento final. Esto refuerza un perfil que no se queda solo en la aplicación, sino que entiende bien lo que ocurre por debajo.\nMe atraen especialmente los entornos donde esa cercanía al hardware se traduce en sistemas técnicamente exigentes y con impacto directo en la fiabilidad global del producto.",
        icons: [ICONS.vivado, ICONS.csharp, ICONS.zynq],
      },
      {
        id: 4,
        title: "Habilidades blandas",
        desc: "En el trabajo valoro tanto la parte técnica como la forma en la que se construyen las cosas en equipo. Me considero una persona curiosa, proactiva y fácil de integrar, cómoda compartiendo ideas, haciendo preguntas y explicando temas técnicos con claridad cuando el contexto lo requiere.\nHe trabajado en entornos internacionales y multidisciplinares, incluyendo colaboraciones vinculadas al programa FCAS, donde coordinarse bien entre perfiles, disciplinas y organizaciones resulta tan importante como acertar en la solución técnica. Esa experiencia me ayudó a desarrollar criterio, capacidad de adaptación y una comunicación profesional clara.\nMe siento cómodo en contextos exigentes, con interlocución diversa y alto nivel de responsabilidad, manteniendo orden, foco y compromiso con la calidad incluso cuando el proyecto aprieta.",
    ...
    myHobbies: [
      {
        ...
        desc: "Me gusta tener pequeños proyectos personales en marcha para explorar ideas, probar tecnologías y aprender construyendo desde cero. Son un espacio donde puedo experimentar con libertad, aplicar lo que voy aprendiendo y, muchas veces, descubrir enfoques o habilidades que después traslado a mi trabajo profesional.",
        img: "https://i.pinimg.com/736x/64/25/d9/6425d9533e83434d24d667db3dbe79bf.jpg",
      },
      {
        id: 2,
        name: "Deporte y actividad física",
        desc: "Practico con regularidad actividades como senderismo, calistenia y running. Me ayudan a mantener disciplina, foco y equilibrio mental, y noto claramente cómo la actividad física mejora tanto mi bienestar como mi productividad y creatividad cuando vuelvo al trabajo.",
        img: "https://i.pinimg.com/736x/82/0f/a7/820fa7d61221505a529323b7d54e0ad4.jpg",
      },
      {
        id: 3,
        name: "Viajes y cultura",
        desc: "Me gusta viajar para descubrir lugares y culturas distintas, salir de mi zona de confort y ganar perspectiva. Conocer otras formas de vida amplía mi manera de ver el mundo y enriquece tanto mi crecimiento personal como mi desarrollo profesional.",
...
export const UI_TEXTS_BY_LANG = {
  es: {
    ...
    hero: {
      ...
      downloadEmbeddedCv: "Descargar CV (Embedded Software Engineer)",
      downloadSoftwareCv: "Descargar CV (Software engineer)",
      linkedin: "LinkedIn",
      github: "GitHub",
      deskHintBadge: "Consejo",
      deskHint: "Para acceder a las diferentes secciones, puedes hacer clic sobre los elementos de la mesa.",
    ...
    work: {
      ...
      downloadEmbeddedCvDesc: "Descarga una versión más detallada de mi perfil, experiencia y foco profesional para el puesto de Embedded Software Engineer.",
      downloadSoftwareCvDesc: "Descarga una versión más detallada de mi perfil, experiencia y foco profesional para el puesto de Software Engineer.",
    ...
    navbar: {
      ...
      languageHint: "Puedes cambiar el idioma aquí.",
      languageHintMobile: "Puedes cambiar el idioma desde aquí.",
      closeHintAria: "Cerrar aviso de idioma",
    },
    contact: {
      heading: "Hablemos",
      subheading: "Si buscas a alguien con buena base técnica, ganas de aprender rápido y capacidad para aportar desde fases tempranas, estaré encantado de hablar contigo.",
      availabilityBadge: "Disponible para nuevas oportunidades",
      introTitle: "Aprendo rápido y disfruto de los proyectos exigentes",
      introBody: "Me gusta trabajar en proyectos donde pueda seguir creciendo mientras aporto valor real, especialmente si combinan software, sistemas y contexto técnico exigente, como defensa, aeroespacio o entornos embebidos.",
      contactEmailLabel: "Correo directo",
      contactEmailValue: "miguelangellarag@gmail.com",
      contactFocusLabel: "Enfoque",
      contactFocusValue: "Software, sistemas críticos, requisitos y arquitectura",
      contactLocationLabel: "Ubicación",
      contactLocationValue: "Sevilla, España",
      fullName: "Nombre completo",
      email: "Correo",
      message: "Tu mensaje",
      namePlaceholder: "Miguel Ángel Lara",
      emailPlaceholder: "miguelangellarag@gmail.com",
      messagePlaceholder: "Hola Miguel Ángel, creo que tu perfil encaja en una posición relacionada con software, sistemas o arquitectura...",
    ...
    partners: {
      title: "Opiniones de mis compañeros",
      starAlt: "estrella",
    },
    footer: {
      terms: "Contacto directo",
      rights: "@ 2025 Miguel Ángel. Todos los derechos reservados.",
    ...
    games: {
      ...
      heading: "Juegos",
      description:
        "En esta sección puedes encontrar los juegos que he desarrollado como hobby, entre ellos Catan o Risk.",
      ...
      loginFailed: "Fallo al iniciar sesión. Revisa tus credenciales.",
      networkTryAgain: "Error de red. Inténtalo de nuevo.",
      cannotAddPlayer: "No se pudo añadir al jugador a la partida.",
      addPlayerNetworkError: "Error de red al añadir jugador.",
      loginRequired: "Debes iniciar sesión para jugar.",
      logoutRequired: "Debes cerrar sesión para entrar como espectador.",
    },
    risk: {
      exit: "Salir",
    ...
    catan: {
      ...
      cameraToggleAlt: "Cambiar vista de cámara",
    ...
    video: {
      noVideo: "No hay un vídeo disponible para este proyecto.",
      cannotShowVideo: "No se pudo mostrar el vídeo.",
      openInTab: "Abrir en una pestaña",
    },
  },
  en: {

...
export default function LaptopSection({ stateSection }) {
  ...
  return (
    <section className={`c-space lg:ml-12 md:mt-48 mt-36 z-10 ${stateSection === STATES.LAPTOP ? "fade-in-delay-3" : "fade-out"}`}>
              ...
              <Canvas>
                  ...
                  <Center>
                      <Suspense fallback={<CanvasLoader />}>
                          <group scale={1.2} position={[0,-1.5,0]} rotation={[0.4, -1.5, 0]}>
